defmodule MethodKnow.Accounts do
  @moduledoc """
  ...
  alias MethodKnow.Accounts.{User, UserToken, UserNotifier}
  ...
  See `MethodKnow.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `MethodKnow.Accounts.User.password_changeset/3` for a list of supported options.
