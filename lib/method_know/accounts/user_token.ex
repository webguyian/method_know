defmodule MethodKnow.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias MethodKnow.Accounts.UserToken
  ...
  @doc """
  Builds a password reset token and its hash to be delivered to the user's email.
  """
