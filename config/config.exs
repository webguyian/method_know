...
config :method_know, :scopes,
  user: [
    default: true,
    module: MethodKnow.Accounts.Scope,
    assign_key: :current_scope,
    access_path: [:user, :id],
    schema_key: :user_id,
    schema_type: :id,
    schema_table: :users,
    test_data_fixture: MethodKnow.AccountsFixtures,
    test_setup_helper: :register_and_log_in_user
  ]

config :method_know,
  ecto_repos: [MethodKnow.Repo],
...
config :method_know, MethodKnow.Mailer, adapter: Swoosh.Adapters.Local
